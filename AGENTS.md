...
`reports/` is generated by `pnpm report` and `pnpm test` and is not committed: the reports
that prove a task are filed in the documentation folder, beside the lot.
