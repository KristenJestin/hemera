...
machine, register the store once: `openspec store register <hemera-docs folder> --id
hemera-docs --yes`. Read the current lot's `proposal.md`, `specs/`, `design.md` and `tasks.md`
