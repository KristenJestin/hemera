/**
 * Generated from 0001-lot-1.sql by `bun tools/migrations.ts --generate`.
 *
 * Edit the SQL file, never this module.
 */

export const sql = `-- Lot 1: projects, workspaces, repositories, sessions, entries, journal, preferences.
