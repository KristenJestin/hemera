...
/** A write in flight draws the square and cannot be pressed: interrupting a write is not this
 * lot's, and a control that looked like it could would be the one lie in the row. */
export const Sending: Story = {
  args: { sending: true, ready: false },
